...
/*************************************************************
  This sketch implements a simple Serial2 receive terminal
  program for monitoring Serial2 debug messages from another
  board.
...
// For the byte we read from the Serial2 port
byte data = 0;
...
// for a full width line, meanwhile the Serial2 buffer may be filling... and overflowing
...
void setup() {
  ...
  tft.drawCentreString(" Serial2 Terminal - 115200 baud ",120,0,2);
...
void loop(void) {
  //  These lines change the text colour when the Serial2 buffer is emptied
