...
// data connection and acquisition variables
   const char* ssid =            "YOUR_SSID";                               // network wifi credentials  
   const char* password =        "YOUR_PASSWORD";                                // wifi network key
   String openWeatherMapApiKey = "YOUR_API_KEY";                        // API Openweathermap account
   String city =                 "YOUR_CITY";
   String countryCode =          "1809858";                                            // "NL" for The Netherlands
