...
#define TIMEZONE CN // See NTP_Time.h tab for other "Zone references", UK, usMT etc
...
// Set the forecast longitude and latitude to at least 4 decimal places //YOUR_CITY_POSITION
const String latitude =  "23.1167"; // 90.0000 to -90.0000 negative for Southern hemisphere
const String longitude = "113.25"; // 180.000 to -180.000 negative for West
