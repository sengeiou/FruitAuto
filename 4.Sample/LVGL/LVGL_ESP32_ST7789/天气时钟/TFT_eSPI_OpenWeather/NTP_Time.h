...
// Zone reference "CN" United Kingdom (London, Belfast)
//TimeChangeRule BST = {"GMT", Last, Sun, Mar, 1, 480};        //British Summer (Daylight saving) Time
TimeChangeRule cnGMT = {"GMT", Last, Sun, Mar, 1, 480};         //Standard Time
Timezone CN(cnGMT, cnGMT);
